...
class ProposeCorrection(AuthenticatedUseCase[CorrectionProposalOut]):
    game_id: ResourceId
    turn_id: int
    release_year: int


@ProposeCorrection.register_handler
class Handler(BaseHandler[ProposeCorrection, CorrectionProposalOut]):
    @inject
    def __init__(
        self,
